...
public class CommandLineParameters {
	public static void main(String[] args){
		...
		Option vmShutdown = new Option("r","randomVM", true, "Shutdown random VM within FCO.");
...
//Logger to be added
        	...
        	listvms.listvms(cloudusername,cloudpassword,cloudapiurl,cloudUUID);
        	System.out.println("Executing stop random VM");

		}
		
		if (commandLine.hasOption("b")){
			String argument = (String) commandLine.getParsedOptionValue("b");
