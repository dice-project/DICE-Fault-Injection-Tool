...
public class RunJmeter {
	...
	public void jmeter(String host, String vmpassword,String planname,String sshkeypath) {
		...
		try {
			...
			String command = "cd /home/"+user+"/apache-jmeter-2.13";
			...
			if (info.equals("No such file or directory found in " + user + "home directory")) {
				command2 = "wget http://www.gtlib.gatech.edu/pub/apache//jmeter/binaries/apache-jmeter-2.13.tgz && tar -xf apache-jmeter-2.13.tgz ";
				LoggerWrapper.myLogger.info("Jmeter tool not found..Downloading......");
			...
			// check not getting called with error
				...
				command2 = "cd /home/"+user+"/apache-jmeter-2.13/ && ./bin/jmeter -n -t "+ planname;

				LoggerWrapper.myLogger.info("Jmeter found..running test......");
			}
