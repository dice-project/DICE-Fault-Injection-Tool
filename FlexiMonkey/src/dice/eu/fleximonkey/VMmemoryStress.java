...
public class VMmemoryStress{
  ...
  public void stressmemory(String cores, String time, String vmpassword, String host, String memorytesterloops){
    try{
      ...
      else if (info.equals("install ok installed"))
     {
    	 ...
    	 // command2=" sudo stress -c 1 -i 2 -m 2 --vm-bytes 512M -t 2m";
    	  ...
    	  System.out.println("memtester loop number: " + memorytesterloops);
